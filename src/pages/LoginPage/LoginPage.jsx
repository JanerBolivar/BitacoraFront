                ...
                <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                    <div className="text-center">
                        ...
                        <div className="mt-5 space-y-2">
                            <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl">Inicie sesión en su cuenta</h3>
                            <p className="">No tienes cuenta?
                                <Link to={"/register"} >
                                    <a href="javascript:void(0)" className="font-medium text-indigo-600 hover:text-indigo-500"> Registrar</a>
                                </Link>
                            </p>
                        </div>
                    </div>
                    <div className="bg-white shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                        ...
                        <div className="relative">
                            ...
                            <p className="inline-block w-fit text-sm bg-white px-2 absolute -top-2 inset-x-0 mx-auto">O inicie sesión con</p>
                        </div>
                        <form
                    ...
                    <div className="text-center">
                        <button onClick={handlePasswordReset} className="hover:text-indigo-600">Olvide mi contraseña</button>
                    </div>
                </div>
            </main>
        </>
