...
const LoginPage = () => {
    ...
    const handlePasswordReset = async () => {
        ...
        try {
            ...
            setError('Error al enviar el email de restablecimiento. Inténtalo de nuevo.');
            console.error(err);
        }
    };
    ...
    return (
        <>
            <Head
                newtitle="Iniciar sesión"
                newdescription="Iniciar sesión en nuestra plataforma"
                newkeywords="login, iniciar sesión, sign in"
            />

            <main className="min-h-screen w-full flex flex-col items-center justify-center bg-gray-50 px-4 py-8">
                <div className="w-full max-w-md space-y-8 text-gray-600">
                    <div className="text-center">
                        ...
                        <div className="mt-6 space-y-2">
                            <h3 className="text-gray-800 text-xl font-bold sm:text-2xl md:text-3xl">
                    ...
                    <div className="bg-white shadow-md rounded-xl p-4 sm:p-6 md:p-8 space-y-6">
                        ...
                        <form onSubmit={handleEmailLogin} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 rounded-lg transition-colors duration-200"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-medium mb-2">
                            ...
                            {successMessage && (
                                <div className="text-green-500 text-sm p-2 bg-green-50 rounded-lg">
                                    {successMessage}
                                </div>
                            )}
                            ...
                            <button
                                type="submit"
                                className="w-full px-4 py-2 text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg transition-colors duration-200"
                            >
                                Ingresar
                            </button>
                        </form>
